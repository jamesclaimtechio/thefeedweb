...
export const metadata: Metadata = {
  title: 'Miami News | The Feed - Coming Soon',
  description:
    'The Feed is expanding to Miami! Stay tuned for breaking news and local stories from the Magic City.',
};
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <p className="mt-6 max-w-md text-zinc-600 dark:text-zinc-400">
        We&apos;re expanding The Feed to Miami! Sign up to be notified when we
        launch coverage in the Magic City.
      </p>
      <div className="mt-8">
        <Link
          href="/"
