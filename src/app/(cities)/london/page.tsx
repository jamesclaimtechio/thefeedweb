...
export const metadata: Metadata = {
  title: 'London News | The Feed - Coming Soon',
  description:
    'The Feed is expanding to London! Stay tuned for breaking news and local stories from the UK capital.',
};
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <p className="mt-6 max-w-md text-zinc-600 dark:text-zinc-400">
        We&apos;re expanding The Feed to London! Sign up to be notified when we
        launch coverage in the UK capital.
      </p>
      <div className="mt-8">
        <Link
          href="/"
